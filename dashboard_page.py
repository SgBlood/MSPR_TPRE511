...
class DashboardPage:
    def __init__(self, root, app):
        ...
        self.subtitle_label = Label(self.frame, text="You are on the Dashboard page", font=("Helvetica", 14), fg='white', bg='#313438')
        ...
        self.btn_dashboard = Button(self.bottom_frame, image=self.icons["dashboard"], relief="flat", bg='#ffffff', bd=0, width=50, height=50, cursor="hand2", command=None)
